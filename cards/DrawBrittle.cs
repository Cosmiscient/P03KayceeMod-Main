...
namespace Infiniscryption.P03KayceeRun.Cards
{
    public class DrawBrittle : AbilityBehaviour
	{
		...
		static DrawBrittle()
		{
			...
			DrawBrittle.AbilityID = AbilityManager.Add(
		...
		protected IEnumerator CreateDrawnCard()
		{
			...
			List<CardInfo> cardsWithBrittle = new List<CardInfo>();
			...
			CardInfo CardToDraw = cardsWithBrittle[UnityEngine.Random.Range(0, cardsWithBrittle.Count)];
