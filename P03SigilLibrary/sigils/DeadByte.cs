...
namespace Infiniscryption.P03SigilLibrary.Sigils
{
    ...
    public class DeadByte : AbilityBehaviour
    {
        ...
        public override IEnumerator OnDie(bool wasSacrifice, PlayableCard killer)
        {
            ...
            yield return LifeManager.Instance.ShowDamageSequence(1, 1, !Card.OpponentCard, 0.25f, ResourceBank.Get<GameObject>("Prefabs/Environment/ScaleWeights/Weight_DataFile_" + prefabSuffix), 0f, true);
            yield break;
        }
