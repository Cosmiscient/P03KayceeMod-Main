...
namespace Infiniscryption.P03SigilLibrary.Sigils
{
    public class MirrorImage : AbilityBehaviour
    {
        ...
        public static readonly Trait Uncopyable = GuidManager.GetEnumValue<Trait>(P03SigilLibraryPlugin.PluginGuid, "Uncopyable");
        ...
        private List<CardSlot> GetCopyableSlots()
        {
            ...
            {
                if (slot.Card != null && slot.Card != this.Card && !slot.Card.HasAbility(AbilityID) && !slot.Card.Info.HasTrait(Uncopyable))
                    possibles.Add(slot);
            }
